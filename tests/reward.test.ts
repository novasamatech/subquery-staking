...
describe("handlePoolSlash", () => {
  ...
  beforeAll(() => {
    ...
    jest
      .spyOn(AccumulatedReward.prototype, "save")
      .mockImplementation(function (this: AccumulatedReward) {
        return Promise.resolve();
      });
    jest.spyOn(Reward.prototype, "save").mockImplementation(function (
      this: Reward,
    ) {
      results.push(this);
      return Promise.resolve();
  ...
  it("Bonded slash", async () => {
    ...
    await handleRelaychainPooledStakingBondedSlash(
      bondedSlashEvent,
      MOCK_GENESIS,
      POOLED_STAKING_TYPE,
    );
  ...
  it("Unbonding slash with no era", async () => {
    ...
    await handleRelaychainPooledStakingUnbondingSlash(
      unbondingSlashEvent,
      MOCK_GENESIS,
      POOLED_STAKING_TYPE,
    );
...
describe("handlePoolReward", () => {
  ...
  it("Pool reward processed properly", async () => {
    ...
    const rewardSpy = jest
      .spyOn(Reward.prototype, "save")
      .mockImplementation(function (this: Reward) {
    ...
    await handleRelaychainPooledStakingReward(
      rewardEvent,
      MOCK_GENESIS,
      POOLED_STAKING_TYPE,
    );
